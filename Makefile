...
pkgdatadir = $(datadir)/lolware_dht
pkgincludedir = $(includedir)/lolware_dht
pkglibdir = $(libdir)/lolware_dht
pkglibexecdir = $(libexecdir)/lolware_dht
...
ACLOCAL = ${SHELL} /root/temp/lol_dht22/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AUTOCONF = ${SHELL} /root/temp/lol_dht22/missing --run autoconf
AUTOHEADER = ${SHELL} /root/temp/lol_dht22/missing --run autoheader
AUTOMAKE = ${SHELL} /root/temp/lol_dht22/missing --run automake-1.11
AWK = mawk
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -Wall -fstack-protector -D_FORTIFY_SOURCE=2 -O2 -I/usr/local/include
CPP = gcc -E
CPPFLAGS = 
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
...
LIBS = -lwiringX 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /root/temp/lol_dht22/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = lolware_dht
PACKAGE_BUGREPORT = 
PACKAGE_NAME = lolware_dht
PACKAGE_STRING = lolware_dht version-0.1
PACKAGE_TARNAME = lolware_dht
PACKAGE_URL = 
...
STRIP = 
VERSION = 0.0.1
abs_builddir = /root/temp/lol_dht22
abs_srcdir = /root/temp/lol_dht22
abs_top_builddir = /root/temp/lol_dht22
abs_top_srcdir = /root/temp/lol_dht22
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /root/temp/lol_dht22/install-sh
